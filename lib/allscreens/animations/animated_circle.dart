...
class AnimatedCircleWords extends StatefulWidget {
  final String? text;
  final String? subtext;
  final Color theColor;
  final IconData theIcon;
  final String theText;
  const AnimatedCircleWords(
      {this.subtext,
      this.text,
  ...
  @override
  _AnimatedCircleWordsState createState() => _AnimatedCircleWordsState();
}

class _AnimatedCircleWordsState extends State<AnimatedCircleWords> {
