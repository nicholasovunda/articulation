...
import 'initial_page_words.dart';

class AnimatedCircleSentence extends StatefulWidget {
  final String? text;
  final String? subtext;
  final Color theColor;
  final IconData theIcon;
  final String theText;
  const AnimatedCircleSentence (
      {
        this.subtext,
        this.text,
  ...
  @override
  _AnimatedCircleSentenceState createState() => _AnimatedCircleSentenceState();
}

class _AnimatedCircleSentenceState extends State<AnimatedCircleSentence> {
