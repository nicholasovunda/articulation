...
class RotatingPageSentence extends StatefulWidget {
  const RotatingPageSentence({Key? key}) : super(key: key);

  @override
  _RotatingPageSentence createState() => _RotatingPageSentence();
}

class _RotatingPageSentence extends State<RotatingPageSentence> {
