...
class RotatingMixedSentence extends StatefulWidget {
  const RotatingMixedSentence({Key? key}) : super(key: key);

  @override
  _RotatingMixedSentence createState() => _RotatingMixedSentence();
}

class _RotatingMixedSentence extends State<RotatingMixedSentence> {
